    ...
    <div class="row mb-3">
        <table class="table table-bordered col-12 border bg-light p-4">
            ...
            <tr>
                ...
                <td style="background-color:white;"><fmt:formatDate pattern="yyyy.MM.dd HH:mm"
                                                                    value="${postDto.postCreatedDate }"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3"><textarea rows="7" class="form-control border-0" disabled
                                          style="background-color:white;">${postDto.content }</textarea></td>
            </tr>
            <tr>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach var="file" items="${postFile }">
                                <a href="download?storedFileName=${file.storedFileName}"
                                   class="btn btn-outline-dark btn-sm">${file.originalFileName }<i
        ...
        <div>
			...
			<span>
				<button class="btn btn-warning btn-xs" data-bs-toggle="modal"
                        data-bs-target="#modal-form-posts">수정</button>
            ...
            <sec:authorize access="hasRole('ADMIN')">
                <c:if test="${postDto.writerNo eq loginUser.userNo}">
                    <button class="btn btn-warning btn-xs" data-bs-toggle="modal" data-bs-target="#modal-form-posts">
                        수정
                    </button>
                </c:if>
                <c:choose>
