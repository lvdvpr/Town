            ...
            <form:form modelAttribute="userRegisterForm" id="form-register" method="post" action="register">
                ...
                <div class="mb-3">
                    ...
                    <div style="display: flex;">
                        <form:input class="form-control" style="flex:15;" path="id" id="id"
                                    placeholder="영문(소문자), 숫자를 이용하여 3~12자리로 공백없이 입력 (단, 시작은 영소문자만 가능하며, 숫자로만 이루어진 아이디는 불가)"
                                    maxLength="12"/>
                        <span style="width:30px;"></span>
                        <button type="button" onclick="registerCheck()" class="btn"
                                style="background-color:cornflowerblue; color:white; min-width:90px; flex:1.5;">중복체크
                        </button>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <form:password class="form-control" path="password" id="password"
                                   placeholder="영문(대/소문자), 숫자, 특수문자를 조합하여 공백없이 8~16자리로 입력" maxLength="16"/>
                    <form:errors path="password" cssClass="text-danger"/>
                </div>
                <div class="mb-3">
                    <label for="passwordConfirm" class="form-label">비밀번호 재입력</label>
                    <span style="color:red;">*</span>
                    <form:password class="form-control" path="passwordConfirm" id="passwordConfirm"
                                   placeholder="영문(대/소문자), 숫자, 특수문자를 조합하여 공백없이 8~16자리로 입력" maxLength="16"/>
                ...
                <div class="mb-3">
                    ...
                    <form:input class="form-control" path="name" id="name"
                                placeholder="영문(대/소문자), 한글을 이용하여 공백없이 2~12자리로 입력" maxLength="12"/>
                ...
                <div class="mb-3">
                    ...
                    <span style="color:red;">*</span>
                    <form:input class="form-control" path="phone" id="phone" placeholder="연락처 입력" onkeyup="autoHyphen()"
                                maxLength="45"/>
                ...
                <div class="mb-3">
                    ...
                    <div style="display: flex;">
                        <button type="button" onclick="searchAddress()" class="btn"
                                style="background-color:cornflowerblue; color:white; min-width:90px; flex:1.5;">주소찾기
                        </button>
                        <span style="width:30px;"></span>
                        <input type="text" class="form-control" style="flex:15;" id="zipcode" name="zipcode"
                               placeholder="주소찾기를 이용하여 입력"/>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3" style="display:none;">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="roleName" id="roleName1"
                                   value="ROLE_USER" checked/>
                            <label class="form-check-label">사용자</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="roleName" id="roleName2"
                                   value="ROLE_ADMIN" onclick="return(false);"/>
